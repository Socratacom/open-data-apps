            ...
            function front_reorder($atts)
                {
                    ...
                    wp_register_style('shortcodes-front_reorder.css', CPTURL . '/css/shortcodes-front_reorder.css');
                    ...
                    include_once(CPTPATH . '/shortcodes/apto_shortcode_reorder_class.php');
